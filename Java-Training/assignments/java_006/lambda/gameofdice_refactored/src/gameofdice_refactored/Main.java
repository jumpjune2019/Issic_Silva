			...
			askOnlyOnce = true;
				...
				if(throwDie.equalsIgnoreCase("q")) {
					...
					if(playerTotal > computerTotal) {
						System.out.println("You have rolled a " + playerDie1 + " and " + playerDie2 + " > the " + label.getLabel(playerDie1, playerDie2));
						System.out.println("I have rolled a " + computerDie1 + " and " + computerDie2 + " > the " + label.getLabel(computerDie1, computerDie2));
